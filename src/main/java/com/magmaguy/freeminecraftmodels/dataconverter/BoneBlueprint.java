...
public class BoneBlueprint {
    ...
    private void adjustCubes() {
        ...
        if (xSize > 48 * MODEL_SCALE || ySize > 48 * MODEL_SCALE || zSize > 48 * MODEL_SCALE) {
            Daedalus.log("Model " + originalModelName + " has a boneBlueprint or set of cubes which exceeds the maximum size! Either make the cubes smaller, less far apart or split them up into multiple bones!");
        }
    ...
    private void processChildren(List<ParsedTexture> parsedTextures, Map<String, Object> boneJSON, String modelName, HashMap<String, Object> values, Map<String, Map<String, Object>> textureReferences, SkeletonBlueprint skeletonBlueprint) {
        ...
        for (Object object : childrenValues) {
            if (object instanceof String) {
                ...
                else Daedalus.log("Model " + modelName + " has an invalid configuration for its cubes!");
            } else {
    ...
    private void writeFile(String modelName, String filename, Map<String, Object> boneJSON) {
        ...
        try {
            ...
            Daedalus.log("Failed to write boneBlueprint resource packs for boneBlueprint " + filename + "!");
