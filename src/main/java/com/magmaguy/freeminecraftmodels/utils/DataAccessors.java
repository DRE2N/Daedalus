...
public class DataAccessors {
    ...
    public static EntityDataAccessor display_posRotInterpolationData = DataMappings.getAccessor(Display.class, "DATA_POS_ROT_INTERPOLATION_DURATION_ID"); // Int
    ...
    public static EntityDataAccessor display_interpolationDelta = DataMappings.getAccessor(Display.class, "DATA_TRANSFORMATION_INTERPOLATION_START_DELTA_TICKS_ID"); // Int
    public static EntityDataAccessor display_viewRangeData = DataMappings.getAccessor(Display.class, "DATA_VIEW_RANGE_ID"); // Float
    public static EntityDataAccessor display_heightData = DataMappings.getAccessor(Display.class, "DATA_HEIGHT_ID"); // Float
    public static EntityDataAccessor display_widthData = DataMappings.getAccessor(Display.class, "DATA_WIDTH_ID"); // Float
    public static EntityDataAccessor textDisplay_text = DataMappings.getAccessor(Display.TextDisplay.class, "DATA_TEXT_ID"); // Component
