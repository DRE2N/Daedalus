...
import de.erethon.daedalus.api.ModeledEntityManager;
...
public class OrientedBoundingBox {
    ...
    private void updateScale() {
        ...
        Attribute scaleAttribute = Attribute.SCALE;
    ...
    public Vector3d getHalfExtents() {
        updateHalfExtents(); // Ensure half extents are up-to-date
        return halfExtents;
    }
    ...
    public Matrix3d getInverseRotation() {
        updateInverseRotation(); // Ensure inverse rotation is up-to-date
        return inverseRotation;
    }

    public Vector3d[] getAxes() {
        updateAxes(); // Ensure axes are up-to-date
        return axes;
    }
    ...
    public ModeledEntity getAssociatedEntity() {
