...
public class BoneBlueprint {
    ...
    public static final float ARMOR_STAND_HEAD_SIZE_MULTIPLIER = 0.4f;
    //This sets the scale of the model for the resource pack
    public static final float MODEL_SCALE = 4f;
    public static final float ARMOR_STAND_PIVOT_POINT_HEIGHT = 1.438F;
    ...
    public BoneBlueprint(String modelName, BoneBlueprint parent, SkeletonBlueprint skeletonBlueprint) {
        this.originalBoneName = "daedalus_autogenerated_root";
        this.boneName = "erethon:" + modelName + "/" + StringToResourcePackFilename.convert(originalBoneName);
    ...
    private void adjustCubes() {
        ...
        if (xSize > 48 * MODEL_SCALE || ySize > 48 * MODEL_SCALE || zSize > 48 * MODEL_SCALE) {
            MessageUtil.log("Model " + originalModelName + " has a boneBlueprint or set of cubes which exceeds the maximum size! Either make the cubes smaller, less far apart or split them up into multiple bones!");
        }
    ...
    private void processChildren(Map<String, Object> boneJSON, String modelName, double projectResolution, HashMap<String, Object> values, Map<String, Map<String, Object>> textureReferences, SkeletonBlueprint skeletonBlueprint) {
        ...
        for (Object object : childrenValues) {
            if (object instanceof String) {
                ...
                else MessageUtil.log("Model " + modelName + " has an invalid configuration for its cubes!");
            } else {
    ...
    private String getModelDirectory(String modelName) {
        return MetadataHandler.PLUGIN.getDataFolder().getAbsolutePath() + File.separatorChar + "output" + File.separatorChar + "Daedalus" + File.separatorChar + "assets" + File.separatorChar + "erethon" + File.separatorChar + "models" + File.separatorChar + modelName;
    }
    ...
    private void writeFile(String modelName, String filename, Map<String, Object> boneJSON) {
        ...
        try {
            ...
            MessageUtil.log("Failed to write boneBlueprint resource packs for boneBlueprint " + filename + "!");
    ...
    public String getOriginalBoneName() {
        return originalBoneName;
    }

    public List<BoneBlueprint> getBoneBlueprintChildren() {
        return boneBlueprintChildren;
    }
    ...
    public CharSequence getCubeBlueprintChildren() {
        StringBuilder sb = new StringBuilder();
        for (CubeBlueprint cubeBlueprint : cubeBlueprintChildren) {
            sb.append(cubeBlueprint.getCubeName()).append(", ");
        }
        return sb.toString();
    }
