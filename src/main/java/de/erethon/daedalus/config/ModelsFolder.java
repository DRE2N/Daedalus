...
public class ModelsFolder {
    ...
    public static void initializeConfig() {
        ...
        if (!file.exists()) {
            Daedalus.log("Failed to create models directory!");
            return;
        }

        if (!file.isDirectory()) {
            Daedalus.log("Directory models was not a directory!");
            return;
        }
    ...
    private static void legacyHorseArmorGeneration(File file) {
        ...
        try {
            ...
            Daedalus.log("Failed to generate the iron horse armor file!");
    ...
    private static void processFiles(File childFile,
        ...
        try {
           ...
           Daedalus.log("Failed to parse model " + childFile.getName() + "! Warn the developer about this");
            e.printStackTrace();
        }
    }
